...
@section('container')
    <div class="main-content">
        <div class="flex flex-col items-center justify-center min-h-screen">
            ...
            @if (auth()->user()->tugasAkhir() !== null && auth()->user()->tugasAkhir->status === 'diajukan')
            ...
            <form action="{{ route('bimbingan.store') }}" method="POST" class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3" class="w-full mt-1 p-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-300">{{ old('deskripsi') }}</textarea>
                </div>
            ...
            @else
            Tidak dapat menambah Bimbingan baru. Silahkan hubungi admin.
            @endif
        </div>
    </div>
@endsection
